...
import com.andyisdope.headsuppoker.Strategies.HoldEmStrat;
import com.andyisdope.headsuppoker.Strategies.PokerHand;
import com.andyisdope.headsuppoker.Utilities.PokerUtilities;
...
public class Table extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Player = PokerPlayer.getInstance();
    ...
    private void ShuffleDeck() {
        ...
        S1.setRankStrat(new HoldEmStrat());
    ...
    private void SendAction(String Action, Double bet, PokerPlayer play) {
        double rebate = 0.0;
