...
import com.andyisdope.headsuppoker.Strategies.RazzHand
import com.andyisdope.headsuppoker.Strategies.Card
import com.andyisdope.headsuppoker.Strategies.Hand
...
class RazzTable : AppCompatActivity() {
    ...
    private var Player: PokerPlayer? = null
    ...
    private fun setListeners() {
        ...
        ActionSeat.addValueEventListener(object : ValueEventListener {
            override fun onDataChange(dataSnapshot: DataSnapshot) {
                ...
                if (Player!!.seat != action[0] && action.size > 1 && Player!!.seat != "NoSeat") {
